...
Before tagging, verify docs match the release:

- [ ] `README.md` version header updated to the new version number
- [ ] `README.md` features list reflects all new functionality added since last release
- [ ] `README.md` API endpoints section includes all new or changed routes
- [ ] `README.md` contains no references to files that don't exist in the repo
- [ ] `CLAUDE.md` API endpoints list is current
- [ ] `CLAUDE.md` Python version reflects the version currently tested against
- [ ] No other docs reference removed files or outdated behaviour

### 3. TaskWarrior Integration Testing
```bash
